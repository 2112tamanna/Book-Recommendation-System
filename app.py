...
popular_df = pickle.load(open('model/popular (1).pkl', 'rb'))
pt = pickle.load(open('model/pt (1).pkl', 'rb'))
books = pickle.load(open('model/Books (1).pkl', 'rb'))
similarity_scores = pickle.load(open('model/similarity_scores (1).pkl', 'rb'))
